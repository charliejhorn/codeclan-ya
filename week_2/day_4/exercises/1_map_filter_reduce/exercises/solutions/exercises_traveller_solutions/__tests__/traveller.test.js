...
describe('Traveller', () => {
    ...
    it('should have a collection of journeys', () => {
        const actual = traveller.journeys;
        expect(actual).toEqual(journeys);
    });

    it('should be able to get the journeys start locations', () => {
    ...
    it('should be able to get the journeys end locations', () => {
